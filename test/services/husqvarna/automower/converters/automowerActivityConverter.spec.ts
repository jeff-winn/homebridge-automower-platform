...
import { AutomowerActivityConverterImpl } from '../../../../../src/services/husqvarna/automower/converters/automowerActivityConverter';

describe('AutomowerActivityConverterImpl', () => {
    let log: Mock<PlatformLogger>;

    let target: AutomowerActivityConverterImpl;

    beforeEach(() => {
        log = new Mock<PlatformLogger>();

        target = new AutomowerActivityConverterImpl(log.object());
    });
