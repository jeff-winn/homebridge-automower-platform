...
- The Automower *must* have an Automower Connect module installed, Bluetooth only mowers will require an upgrade. For more information, please contact your local Husqvarna Automower dealer.
